...
\begin{tabular}{c | c | c | c | c | c} 
 \toprule
 \multirow{2}*{$(a_x, b_y)$} & \multicolumn{4}{c|}{$p_C(a_x, b_y|A_x,B_y)$} & \multirow{2}*{$\mathit{CHSH}$} \\ \cline{2-5}
