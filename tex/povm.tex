...
Once the rank-1 operators $\{E_k\}$ and the weights $\{a_k\}$ conforming the POVM set elements $B_k=a_k E_k$ are obtained, we can use Equation  \ref{eq:rank1_povm} to perform the following assignment
\begin{equation}
    p_k = \frac{a_k}{2}
\end{equation}
\begin{equation}
